...
import 'package:flutterapp/tihapp/generatediphone11prox109widget/generated/GeneratedVectorWidget473.dart';
import 'package:flutterapp/helpers/transform/transform.dart';

/* Frame ion:chevron-back-circle-sharp
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedIonchevronbackcirclesharpWidget5 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return TransformHelper.rotate(
        ...
        child: GestureDetector(
          onTap: () =>
              Navigator.pushNamed(context, '/GeneratedIPhone11ProX108Widget'),
          child: ClipRRect(
