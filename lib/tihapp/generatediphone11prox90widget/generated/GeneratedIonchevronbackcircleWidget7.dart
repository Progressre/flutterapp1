...
import 'package:flutterapp/tihapp/generatediphone11prox90widget/generated/GeneratedVectorWidget68.dart';
import 'package:flutterapp/helpers/transform/transform.dart';

/* Frame ion:chevron-back-circle
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedIonchevronbackcircleWidget7 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return TransformHelper.rotate(
        ...
        child: GestureDetector(
          onTap: () =>
              Navigator.pushNamed(context, '/GeneratedIPhone11ProX67Widget'),
          child: ClipRRect(
