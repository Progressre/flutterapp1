...
import 'package:flutterapp/tihapp/generatediphone11prox8widget/generated/GeneratedVectorWidget52.dart';

/* Frame ion:chevron-back-circle-sharp
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedIonchevronbackcirclesharpWidget1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return TransformHelper.rotate(
        ...
        child: GestureDetector(
          onTap: () =>
              Navigator.pushNamed(context, '/GeneratedIPhone11ProX69Widget'),
          child: ClipRRect(
