...
import 'package:flutterapp/tihapp/generatediphone11prox91widget/generated/GeneratedVectorWidget79.dart';
import 'package:flutterapp/helpers/transform/transform.dart';

/* Frame ion:chevron-back-circle
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedIonchevronbackcircleWidget10 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return TransformHelper.rotate(
        ...
        child: GestureDetector(
          onTap: () =>
              Navigator.pushNamed(context, '/GeneratedIPhone11ProX68Widget'),
          child: ClipRRect(
