...
import 'package:flutterapp/tihapp/generatediphone11prox111widget/generated/GeneratedVectorWidget484.dart';

/* Frame ion:chevron-back-circle-sharp
    Autogenerated by FlutLab FTF Generator
  */
class GeneratedIonchevronbackcirclesharpWidget8 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return TransformHelper.rotate(
        ...
        child: GestureDetector(
          onTap: () =>
              Navigator.pushNamed(context, '/GeneratedIPhone11ProX112Widget'),
          child: ClipRRect(
